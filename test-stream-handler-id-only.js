...
/**
 * Script de prueba simplificado para verificar solo la validación de IDs
...
async function testIdValidationOnly() {
  console.log('🔄 PRUEBA DE VALIDACIÓN DE IDs - SIN DEPENDENCIAS');
  console.log('='.repeat(60));

  // Crear servicios necesarios
  const logger = new MockLogger();
  const detector = new IdDetectorService();
  const validator = new DynamicValidationService(detector, null); // Sin servicio de conversión
