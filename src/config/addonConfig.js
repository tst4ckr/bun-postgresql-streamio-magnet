...
const config = {
  ...
  torrentio: {
    movie: {
      ...
      limit: parseInt(process.env.TORRENTIO_MOVIE_LIMIT) || 6,
    ...
    series: {
      ...
      limit: parseInt(process.env.TORRENTIO_SERIES_LIMIT) || 6,
    ...
    anime: {
      ...
      limit: parseInt(process.env.TORRENTIO_ANIME_LIMIT) || 6,
