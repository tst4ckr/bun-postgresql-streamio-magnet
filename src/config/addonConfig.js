...
const config = {
  ...
  repository: {
    ...
    torrentioApiUrl: process.env.TORRENTIO_API_URL || 'https://torrentio.strem.fun/providers=horriblesubs,nyaasi,tokyotosho,anidex,mejortorrent,wolfmax4k,cinecalidad%7Csort=seeders%7Cqualityfilter=scr,cam,unknown%7Climit=2%7Csizefilter=12GB',
