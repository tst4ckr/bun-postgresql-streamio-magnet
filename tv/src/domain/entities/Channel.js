...
export class Channel {
  ...
  // Campos opcionales para imágenes adicionales
  get poster() { return this.#metadata?.poster || null; }
  get background() { return this.#metadata?.background || null; }
  ...
  static fromCSV(csvRow) {
    ...
    return new Channel({
      ...
      metadata: {
        source: 'csv',
        // Capturar campos adicionales si existen en el CSV
        poster: csvRow.poster,
        background: csvRow.background,
        originalData: csvRow
      }
    });
  }
