...
export class IPTVLibrary extends EventEmitter {
    ...
    async initialize() {
        ...
        try {
            ...
            // Cargar variables de entorno desde archivo de configuración .conf (una sola vez)
            // Ahora se carga siempre de forma segura; ConfLoader no sobreescribe valores existentes.
            ...
            this.processor = new IPTVProcessor({
                ...
                // Propagar enableMetrics si está presente en options
